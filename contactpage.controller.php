            ...
            <div class="col-md-10 content">
                ...
                <div class="card contact-card mb-4">
                    <div class="card-body">
                        ...
                        <form action="admin/online_sale_update.php" method="POST">
                ...
                <div class="card contact-card mb-4">
                    <div class="card-body">
                        ...
                        <form action="admin/customer_care_update.php" method="POST">
                ...
                <div class="card contact-card mb-4">
                    <div class="card-body">
                        ...
                        <form action="admin/tech_support_update.php" method="POST">
