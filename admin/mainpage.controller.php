...
<body>
    ...
    <div class="container my-4">
        ...
        <!-- Upload New -->
        <form action="banner_upload.php" method="POST" enctype="multipart/form-data" class="mb-4">
            <div class="mb-2">
                        ...
                        <div class="card-body">
                            <form action="banner_update.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="banner_delete.php?id=<?= $image['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this image?')">Delete</a>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 shadow">
                        ...
                        <div class="card-footer bg-white border-top">
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="brand_update.php?id=<?= $brand['id'] ?>" class="btn btn-sm btn-success">Update</a>
                                <a href="brand_delete.php?id=<?= $brand['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this brand and its images?')">Delete</a>
                            </div>
                        </div>
                    </div>
                </div>
