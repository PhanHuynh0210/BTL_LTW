    ...
    <div class="app">
        <div class="sidebar">
            <div class="sidebar__logo">
                ...
                <p class="sidebar-logo__name">DiDongThongMinh</p>
            </div>
            <ul class="sidebar__nav">
                ...
                <li class="sidebar-nav__item">
                    <a href="product-manage.php" class="sidebar-nav-item__link"><span class="sidebar-nav-item__icon material-symbols-outlined">watch</span>Điện Thoại<span></a>
                </li>
                <li class="sidebar-nav__item">
                ...
                <li class="sidebar-nav__item">
                    <a href="about_manage.php" class="sidebar-nav-item__link"><span class="sidebar-nav-item__icon material-symbols-outlined">forklift</span>Giới thiệu<span></a>
                </li>
                <li class="sidebar-nav__item">
